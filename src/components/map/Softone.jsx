...
import background from "../../assets/img/soft11.png";
...
const Softone = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      dispatch(locationActions.setLocation("softtwo"));
    }
  ...
  return (
    <div>
      ...
      {downBtn && (
        <Button direction="down" arrow={downArrow} location="software" />
      )}
